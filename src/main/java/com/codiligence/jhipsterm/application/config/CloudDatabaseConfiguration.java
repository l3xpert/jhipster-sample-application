package com.codiligence.jhipsterm.application.config;
...
@Configuration
@EnableMongoRepositories("com.codiligence.jhipsterm.application.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.codiligence.jhipsterm.application.config.dbmigrations");
